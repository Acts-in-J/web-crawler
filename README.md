...
- **법적 위험이 큰 요청은 구체적으로 경고** — 저작권 침해 목적의 본문 복제(④ 분량), 개인정보 대량수집(③ 성격), 명시적으로 금지된 재배포(⑤ 이용). 이런 요청을 받으면 **여섯 조건 중 어느 축이 왜 걸리는지 짚어서 알린 뒤, 진행 여부는 사용자가 정합니다.** 근거를 제출받거나 심사하지 않습니다. *약관이 크롤링을 금지한다는 사실만으로는 여기 해당하지 않습니다 — 그건 위 ① 의 계약 층이고, 확인 절차로 갑니다.*
