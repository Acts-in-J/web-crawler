...
5. **위 넷에 해당하지 않아도, 아래 여섯 조건을 지키면 검색엔진이 매일 하는 일과 같습니다.**
...
**여섯을 다 지키면 녹색, 하나가 빠지면 노랑, ① 이 빠지면 빨강입니다.**
① 만 색이 다른 이유는 **거기에만 형사 층이 있기** 때문입니다.

④ 가 가장 자주 빠뜨리는 축입니다. 대법원 기준이 *"상당한 부분의 복제와 같은 결과"* 라서,
...
hiQ 는 로그인 없이 공개 페이지만 긁었는데 이용약관 위반으로 $50만을 물었습니다.

**Q. 개인정보만 아니면 되나요?**
A. 아닙니다. 사실 정보라도 **체계적으로 모아둔 집합에는 별도 권리**가 붙습니다.
잡코리아 채용공고는 개인정보도 저작물도 아니었지만 DB제작자 권리 침해로 4.5억이었습니다.

**Q. 팔지 않고 회사 내부 분석용으로만 쓰면 괜찮나요?** ← **가장 흔한 오해**
A. **네 축 중 하나만 낮아집니다.** 접근(침입·우회)·부담(업무방해)·개인정보는 그대로입니다.
형사 층은 사실상 전부 접근·부담에 있어서 "내부용이니 형사는 괜찮다" 는 성립하지 않습니다.
함정이 셋 더 있습니다:

- **저작권법의 "사적이용"(§30) 은 회사 내부를 포함하지 않습니다.** 조문은 *"가정 및 이에 준하는
  한정된 범위"* 를 요구하고, 판례는 **기업 내부의 조직적 복제를 여기서 배제**합니다.
  "회사 내부" 는 "사적" 의 확장이 아니라 정반대입니다.
...
이 도구는 차단된 사이트에 대해 **우회를 시도할 수 있는 능력을 제공하지만, 그 지점에서 반드시
한 번 확인을 구합니다.** 진행 여부의 판단과 그 결과에 대한 책임은 사용자에게 있습니다.
